...
public class VokabelManuell extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        alleKategorien.observe(this, new Observer<List<Kategorie>>() {
            @Override
            public void onChanged(List<Kategorie> categories) {
                if (categories != null) {
    ...
    private void restartIfUpdated() {
        ...
        alleKategorien.observe(VokabelManuell.this, new Observer<List<Kategorie>>() {
            @Override
            public void onChanged(List<Kategorie> categories) {
                if (categories != null) {
